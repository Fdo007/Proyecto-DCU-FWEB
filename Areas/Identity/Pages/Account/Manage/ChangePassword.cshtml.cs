...
namespace Proyecto_DCU_FWEB.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "La contraseña debe tener por lo menos {2} y un maximo de {1} caracteres.", MinimumLength = 6)]
            [DataType(DataType.Password)]
            ...
            [Compare("NewPassword", ErrorMessage = "La nueva contraseña y la de confirmacion no coinciden.")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Se ha cambiado con exito.";
